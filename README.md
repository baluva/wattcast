...
Another check found that about 5 % of the forecast-weather archive was missing (mostly Lille in 2022-2023) and had been silently filled with fresher forecasts. Missing cities are now dropped from the national average instead, and the 22 days where that is not enough are excluded from scoring for both competitors.
